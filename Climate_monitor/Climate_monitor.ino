//**********************************************************************************//
//    Nombre:   Monitor de ambiente                                                 //
//    Autor:    Diego Lorca                                                         //
//    Objetivo: El programa lleva a cabo la comunicación entre el sensor DHT11      //
//              y el display LCD Nokia5110 para visualizar temperatura y humedad    //
//              del ambiente                                                        //
//**********************************************************************************//
...
void loop()
{
  ...
  String ts = String(t);
  String hs = String(h);
  const int length_t = ts.length();
  const int length_h = hs.length(); 
  char* tc = new char[length_t + 1];
  char* hc = new char[length_h + 1];
